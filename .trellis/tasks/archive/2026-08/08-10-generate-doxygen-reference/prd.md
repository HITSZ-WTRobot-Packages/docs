...
- [x] Header-only, compiled, C, and C++ fixtures generate valid symbol data.
- [x] API references remain associated with the correct package and source revision.
- [x] Empty or sparsely documented packages do not break the site build.
- [x] Private or non-reproducible tooling requirements trigger the architecture issue gate.
